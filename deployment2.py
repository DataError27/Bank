...
with sidebar_col:
    ...
    if ticker and data_file and model_file:
        ...
        # Placeholder for the informational message
        info_placeholder = st.empty()
        info_placeholder.info("Note: Running the machine learning model may take a while. Please be patient as we process the data.")
        ...
        # Load the existing data from the CSV file
        previous_exog_data = load_existing_data(data_file)
        ...
        if combined_data[exog_vars].isnull().values.any():
            ...
            # Clear the informational message after prediction is completed
